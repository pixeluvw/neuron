...
- Replaced deprecated `axisAlignment` on `SizeTransition` with `alignment: Alignment.topCenter` in `NeuronPageTransition.size` to resolve a pub.dev static analysis warning.

## [1.6.1] - 2026-04-04

### Documentation

- Updated CHANGELOG, README, and library docs for 1.6.0 features.
- Updated test badge to 262 passing.
